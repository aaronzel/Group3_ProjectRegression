...
This category includes variables that affect interest rate and default rate in opposite directions. This means that the borrower receives a higher interest despite having a lower risk of default, or the borrower receives lower interest rate despite having higher risk of default. 
<br />
<br /> 
...
```
However, as we can see, most people who defaulted do not even have a principal balance. 
### Conclusion
