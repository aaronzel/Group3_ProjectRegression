...
*Linear Regression* 
See below for a linear model determining how interest rates for loans are determined.

We will create and run the model, analyze credit risks, then proceed to analyze the model. 
...
predicted_results <- ifelse(test_pred_2 > 0.1, 1, 0) 
...
accuracy_logit2 <- (6038+57)/6660

accuracy_met <- c(accuracy_logit1,accuracy_logit2)

error_logit1 <- 1-accuracy_logit1
error_logit2 <- 1-accuracy_logit2
error_met <- c(error_logit1, error_logit2)

sensitivity_logit1 <- 4/300
sensitivity_logit2 <- 57/300
sensitivity_met <- c(sensitivity_logit1, sensitivity_logit2)


specificity_logit1 <- 6359/6360
specificity_logit2 <- 6038/6360
specificity_met <- c(specificity_logit1,specificity_logit2)

precision_logit1 <- 4/5
precision_logit2 <- 57/379
precision_met <- c(precision_logit1,precision_logit2)

logit_metrics.df <- data.frame(c("Model 3", "Model 3 low"), accuracy_met, error_met, sensitivity_met, specificity_met, precision_met)
logit_metrics.df
