...
The graph above shows that amount funded has a negative relationship to the borrower rate. This means that the market perceive people with higher amount funded to have lower risk, and thus give a lower interest rate.
